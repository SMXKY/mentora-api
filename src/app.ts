...
import bookingRouter, { bookingAdminRouter, safetyAlertAdminRouter } from "./modules/booking/booking.route";
...
app.use("/api/v1/admin/safety-alerts", safetyAlertAdminRouter);
