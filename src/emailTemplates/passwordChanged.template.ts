...
export const buildPasswordChangedEmailTemplate = (params: {
            ...
            <tr>
              <td style="background-color:#ffffff;padding:48px 48px 40px;border-left:1px solid #d3d1c7;border-right:1px solid #d3d1c7;">
                ...
                <p style="margin:0 0 36px;font-size:16px;color:#5f5e5a;line-height:1.7;">
                  ...
                  }, your Mentora account password was changed on <strong style="color:#1a1c1e;">${
  params.timestamp
}</strong>.
                </p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
                  <tr>
                    <td style="background-color:#e6f6f0;border:1.5px solid #a8dfc9;border-radius:12px;padding:20px 24px;">
                      <p style="margin:0;font-size:14px;color:#1a7a56;line-height:1.65;">
                        Your password has been updated. All previous sessions have been invalidated.
                      </p>
                    </td>
                  </tr>
                </table>
                ...
                <p style="margin:0;font-size:13px;color:#888780;line-height:1.65;padding-top:28px;border-top:1px solid #ebe9e3;">
                  This is a security notification for your Mentora account. Please do not share it with anyone.
                </p>
              </td>
            </tr>
