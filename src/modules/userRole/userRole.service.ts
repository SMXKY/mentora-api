...
import { CreateUserRoleInput, UpdateUserRoleInput } from "./userRole.types";
...
export class UserRoleService extends BaseService<
  ...
  UpdateUserRoleInput
> {
  protected repository = new UserRoleRepository();
  ...
  // protected async beforeCreate(data: CreateUserRoleInput, ctx: ServiceContext) {
  ...
  // protected async beforeUpdate(id: string, data: UpdateUserRoleInput, ctx: ServiceContext) {
