...
import {
  ...
  UpdateTestResourceInput,
} from "./testResource.types";
...
export class TestResourceService extends BaseService<
  ...
  UpdateTestResourceInput
> {
  protected repository = new TestResourceRepository();
  protected tableName = "testResource";
  ...
  // protected async beforeCreate(data: CreateTestResourceInput, ctx: ServiceContext) {
  ...
  // protected async beforeUpdate(id: string, data: UpdateTestResourceInput, ctx: ServiceContext) {
